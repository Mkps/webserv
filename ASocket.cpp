...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/17 14:50:37 by aloubier          #+#    #+#             */
/*   Updated: 2024/06/17 14:51:51 by aloubier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ASocket::ASocket(std::string IPAddress, int portNumber)
{
	(void)IPAddress;
...
int const & ASocket::getFd() const
{
	return _socket;
}
void	ASocket::log(std::string const & msg) const
{
	std::cout << msg << std::endl;
}

void ASocket::startListen()
{
    if (listen(_socket, 20) < 0)
    {
		std::cerr << "ASocket listen failed" << std::endl;

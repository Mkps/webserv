...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/17 14:50:46 by aloubier          #+#    #+#             */
/*   Updated: 2024/06/17 14:51:46 by aloubier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClientSocket::ClientSocket(std::string IPAddress, int portNumber)
{
	(void)IPAddress;
...
int const & ClientSocket::getFd() const
{
	return _socket;
}
void	ClientSocket::log(std::string const & msg) const
{
	std::cout << msg << std::endl;
}

void ClientSocket::startListen()
{
    if (listen(_socket, 20) < 0)
    {
		std::cerr << "ClientSocket listen failed" << std::endl;
